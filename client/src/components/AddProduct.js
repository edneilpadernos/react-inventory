...
function AddProduct(props) {
    ...
    const {addProduct,getProducts,setProductList} = useContext(ProductContext)
                ...
                <form onSubmit={handleSubmit}>
                    <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <div className="mt-3 text-left sm:mt-0 sm:ml-4">
                            <h3 className="text-lg font-medium leading-6 text-gray-900" id="modal-title">Add Product</h3>
                            { 
                            error && error.show &&
                            ...
                            <input type="text" ref={nameRef} placeholder="product name" id="productName" className="border p-2 w-full" required/>
                            </div>
                            <div className="py-1">
                    ...
                    <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                        <button type="submit"  className="inline-flex w-full justify-center rounded-md border border-transparent bg-red-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-red-700  sm:ml-3 sm:w-auto sm:text-sm">Add</button>
